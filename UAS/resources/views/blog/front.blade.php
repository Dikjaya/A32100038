...
<body>
    ...
    <header class="fadeIn">
        <img src="{{asset('storage/app/public/images/pasfoto.jpg')}}images/pasfoto.jpg" alt="foto">
        <h1>Nama Saya Muhamad Yasa A32100038</h1>
        <p>Web Developer</p>
    </header>
    ...
    <section id="tentang-saya" class="fadeIn">
        <h2>Tentang Saya</h2>
        <p>Selamat datang di portofolio saya. Saya adalah seorang mahasiswa dan pengembang web dengan minat dalam teknologi dan desain. Berikut adalah beberapa proyek yang telah saya kerjakan.</p>
    </section>
    ...
    <section id="blog">
        ...
        <section id="kontak" class="fadeIn">
            ...
            <div class="social">
                ...
                <a href="https://github.com/MuhamadYasa" target="_blank">GitHub</a>
